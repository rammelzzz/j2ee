...
public class CookieUtil {
    ...
    public static void addCookie(HttpServletResponse response, String name,
        ...
        try {
            ...
            LoggerUtil.error(CookieUtil.class, "创建Cookies发生异常！", ex);
        }
    }
    /**
    ...
    public static boolean clearCookie(HttpServletRequest request,
        ...
        try {
            for (int i = 0; i < cookies.length; i++) {
                ...
                cookie.setMaxAge(0);
                cookie.setPath("/");// 根据创建cookie的路径进行填写
                response.addCookie(cookie);
                bool = true;
            }
        } catch (Exception ex) {
            LoggerUtil.error(CookieUtil.class, "清空Cookies发生异常！", ex);
        }
        return bool;
    }
    /**
    ...
    public static String findCookieByName(HttpServletRequest request,
        ...
        try {
            ...
            LoggerUtil.error(CookieUtil.class, "获取Cookies发生异常！", ex);
        }
        return string;
    }
}
